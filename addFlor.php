<?php
    if(isset($_POST['tipoArreglo'])){
        ...
        $query = "INSERT INTO catalogoprincipal`(`tipo_arreglo`, `tipo_flor_1`, `color_flor_1`, `cantidad_1`, `tipo_flor_2`, `color_flor_2`, `cantidad_2`, `tipo_flor_3`, `color_flor_3`, `cantidad_3`, `cantidad_flores`, `tamaño`, `precio`) VALUES ($tipoArreglo,$tipoFlor1,$color1,$cantidad1,$tipoFlor2,$color2,$cantidad2,$tipoFlor3,$color3,$cantidad3,$cantidadTotal,$tamaño,$precio)";

        echo "<script>alert('Arreglo agregado')</script>";
